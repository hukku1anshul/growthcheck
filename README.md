...
overlapping ranges, and age is compared as the implied **birth year**, because
an age means nothing without the date it was reported on.

That last point was learned twice. The figure had settled at 97.5% across two
publishers; adding the 2019 affidavits and two more publishers sent it to 57.3%
overnight, and not one of the new disagreements was real. The comparison was
picking an arbitrary claim per publisher, so it read a member's 2019 age against
another register's 2024 age; and the party alias learner treated every value a
person had ever been given as proof those names meant the same party, so every
MP who had **crossed the floor** taught it that Congress and the BJP were one
